...
import 'package:flutter_youtube_ui_clone/common_widget/home/shorts.dart';
...
class HomeScreen extends StatelessWidget {
  final VideoThumbnailData videoThumbnailData = const VideoThumbnailData(
  ...
  Widget build(BuildContext context) {
    return SliverList(
      delegate: SliverChildListDelegate([
        Video(thumbnailData: videoThumbnailData),
        Video(thumbnailData: videoThumbnailData),
